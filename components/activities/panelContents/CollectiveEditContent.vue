<template>
  <div>
    <v-form
      ...
      class="black--text"
    >
      <v-row class="d-flex flex-wrap flex-row align-stretch justify-center mb-0 pb-0">
        <v-col>
          <h3>
            NOMBRE DEL EVENTO
          </h3>
          <v-text-field
            v-model="editActivity.event"
            flat
            outlined
            dense
            type="text"
      ...
      <v-row class="d-flex flex-wrap flex-row align-stretch justify-center mt-0 pt-0">
        <v-col>
          <h3>
            HORAS
          </h3>
