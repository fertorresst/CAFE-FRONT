...
export default {
  ...
  data () {
    return {
      ...
      areaItems: [
        { text: 'DP/VSS - DESARROLLO PERSONAL / VIDA SALUDABLE Y SUSTENTABLE', value: 'DP/VSS' },
        { text: 'RS/VCI - RESPONSABILIDAD SOCIAL / VOCACION CIENTIFICA Y TECNOLOGICA', value: 'RS/VCI' },
        { text: 'CEE/EIE - CULTURA EMPRENDEDORA Y EMPRESARIAL / ESPÍRITU INNOVADOR Y EMPRENDEDOR', value: 'CEE/EIE' },
        { text: 'FCI/ICP - FORMACIÓN CULTURAL E INTEGRAL / INTERCULTURALIDAD Y CONVIVENCIA PARA LA PAZ', value: 'FCI/ICP' },
        { text: 'AC - AREA COMPLEMENTARIA', value: 'AC' }
      ]
    }
  },
